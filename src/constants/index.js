...
export const EXPERIENCES = [
  ...
  },
  {
    ...
    description: [
      ...
      "Implemented RESTful services and backend automation workflows for targeted diagnostics diagnostics and testing, reducing redundant test cycles.",
  ...
  },
  {
    ...
    description: [
      ...
      "Built web-based internal tools (HTML, CSS, JavaScript) integrated with backend diagnostics, improving workflow efficiency by 25% and reducing onboarding time by 20% (500+ users).",
    ],
